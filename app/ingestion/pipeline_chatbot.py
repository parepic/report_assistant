...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Chatbot pipeline: chunk, embed, and LLM stages.")
    ...
    if not (args.chunk or args.embed or args.llm):
        ...
        print("Embedding completed. Starting LLM conversation...")
        llm_main(config)
